(function() {
    ...
    function FileManagerCtrl($scope, $http, $location, $stateParams) {
        ...
        var baseurl = 'http://117.50.1.134:8090/api/' + 'vv';
        console.log(baseurl);
        ...
        var downloadFile = function(file) {
            window.open(baseurl + file.relPath);
        };
        ...
        FM.download = function() {
            ...
            for (var i in FM.selection) {
                link.setAttribute('href', baseurl + FM.selection[i].relPath);
        ...
        FM.move = function(target) {
            var url = baseurl + encodeURI(target);
        ...
        FM.archive = function(archive) {
            ...
            var url = baseurl + FM.curFolderPath + encodeURI(archive);
            var src = FM.selection.map(function(file) {
                return file.relPath;
            });
        ...
        FM.rename = function(newName) {
            var url = baseurl + FM.selection[0].relPath;
        ...
        FM.createFolder = function(folderName) {
            var url = baseurl + FM.curFolderPath + encodeURI(folderName);
        ...
        FM.upload = function() {
            ...
            var url = baseurl + FM.curFolderPath + encodeURI(FM.uploadFile.name);
